#include "NumberBaseball/Public/Mode/NBGameModeBase.h"
#include "Mode/NBGameStateBase.h"
...
void ANBGameModeBase::BeginPlay()
{
	...
	UE_LOG(LogTemp, Warning, TEXT("SECRET NUMBER GENERATED: %s"), *SecretNumberString);
	UE_LOG(LogTemp, Warning, TEXT("====================================="));
}
